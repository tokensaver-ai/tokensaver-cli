...
- feat(catalog): introduce combined dashboard endpoint and refactor stats retrieval
- fix(egress): N tours require N loop iterations (0.1.35)
- fix(egress): lab /goal without fake metrics (0.1.34)
- fix(egress): stop hook must not continue /goal (0.1.33)
- fix(egress): end /goal labs with work_complete (0.1.32)
- feat(egress): silent Boucles on /goal via hooks + skill (0.1.31)
- feat(cli): sync egress-aware BusinessLoop skills
- feat: ship vibe-coding Boucles — evaluator, Espace développeur, skills
- feat(egress): Claude MCP auto-manages BusinessLoops (0.1.27)
- fix(cli): load egress bridge paths at runtime without overriding API URL
- feat: bridge egress saved env into CLI loop status
- fix(cli): keep loop --export stdout clean for shell eval
- feat(cli): add tokensaver loop for ACP-9 business loops
- docs(egress): document two-terminal logs + claude --no-start
- feat(compression): improve net token savings logic and add tests
...
[Unreleased]: https://github.com/tokensaver-ai/tokensaver-cli/compare/v0.3.42...HEAD
[0.3.42]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.42
[0.3.41]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.41
[0.3.40]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.40
[0.3.39]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.39
[0.3.38]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.38
[0.3.37]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.37
[0.3.36]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.36
[0.3.35]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.35
[0.3.34]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.34
[0.3.33]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.33
[0.3.32]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.32
[0.3.31]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.31
[0.3.30]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.30
[0.3.29]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.29
[0.3.28]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.28
[0.3.27]: https://github.com/tokensaver-ai/tokensaver-cli/releases/tag/v0.3.27
