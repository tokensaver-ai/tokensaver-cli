...
| **Agentic graph** | Handoffs multi-agents tracés en temps réel — console → *Graphe agentique* |
| **Espace développeur** | Projets + Boucles + deep-links Cost Management — console → *Espace développeur* |
| **Business loops** | Goals / max turns → `/tokensaver-router:loop` or skill `tokensaver-agentic-loops` |
