...
def run_flows(
    *,
    ...
    print("TokenSaver Flux IA — real-time AI runs from Claude Code")
    print("  Every message through TokenSaver appears here live (pipeline, tokens, cost).")
    print(f"  Console: {url}")
    if flow_id:
    ...
    if runs:
        ...
        print("No recent runs yet — send a message in Claude, then refresh Flux IA.")
        print()
