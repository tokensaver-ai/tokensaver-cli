...
def resolve_route_config(*, force_local: bool = False) -> RouteConfig:
    ...
    if want_local:
        ...
        # Custom / staging SaaS URL from env.
        api_host = env_host
    elif creds and creds.api_host:
        # Prefer sticky login host over a monorepo .env that points at localhost.
    ...
    elif creds and creds.console_url and (want_local or not _is_local_host(creds.console_url)):
        console_url = creds.console_url
    else:
