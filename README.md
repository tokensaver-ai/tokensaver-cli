...
- **Business loops (ACP-9)** — `tokensaver loop start|tick|end|status` to govern vibe-coding sessions → [vibe-coding-loops.md](docs/vibe-coding-loops.md)
...
Observability  flows · loop · status
...
| `/tokensaver-router:loop` | BusinessLoop start/tick/end (ACP-9) |
